...
class RecorderVideoFragment : Fragment(),
    ...
    override fun onResume() {
        ...
        // a camera and connect preview from here (otherwise, we wait until the surface is isReady in
    ...
    private fun startRecordingVideo() {
        ...
        try {
            ...
            // Once the session starts, we can updateState the UI and connect recording
