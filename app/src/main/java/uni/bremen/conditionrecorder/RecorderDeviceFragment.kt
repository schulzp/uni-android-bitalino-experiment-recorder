...
class RecorderDeviceFragment : Fragment(), OnBITalinoDataAvailable, View.OnClickListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_recorder_device, container, false)
    }
    ...
    companion object {
        ...
        fun newInstance():RecorderDeviceFragment = RecorderDeviceFragment()
    }
}
